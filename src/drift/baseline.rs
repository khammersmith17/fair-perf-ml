...
pub(crate) struct BaselineCategoricalBins {
    pub(crate) idx_map: HashMap<String, usize>,
...
impl BaselineCategoricalBins {
    ...
    pub(crate) fn new<S: StringLike>(baseline_data: &[S]) -> BaselineCategoricalBins {
    ...
    pub(crate) fn export_baseline(&self) -> HashMap<String, f64> {
        self.idx_map
            .iter()
    ...
    pub(crate) fn reset<S: StringLike>(&mut self, baseline_data: &[S]) {
        let n = baseline_data.len() as f64;
